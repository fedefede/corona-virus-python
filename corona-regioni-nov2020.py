...
make_map(X_last_update_regions, 'totale_casi', 'numero totale di casi')    
make_map(X_last_update_regions, 'morti_per_100000_abitanti', 'morti_per_100000_abitanti')    
make_map(X_last_update_regions, 'positivity_rate', 'positivity rate [%] for the last update')    
